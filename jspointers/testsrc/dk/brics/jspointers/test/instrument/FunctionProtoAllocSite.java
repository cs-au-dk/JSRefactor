...
public class FunctionProtoAllocSite extends AllocSite {
	private IFunction exp;

	public FunctionProtoAllocSite(IFunction exp) {
		this.exp = exp;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FunctionProtoAllocSite other = (FunctionProtoAllocSite) obj;
		if (exp == null) {
			if (other.exp != null)
				return false;
	...
	public <A> A apply(AllocSiteAnswerVisitor<A> v) {
		return v.caseFunctionProto(this);
	}
	@Override
	public void apply(AllocSiteVisitor v) {
	    v.caseFunctionProto(this);
	}
}
