...
Soft3d = (function() {
    ...
    function ax(aK, aJ) {
        return{x:aK.y * aJ.z - aK.z * aJ.y,y:aK.z * aJ.x - aK.x * aJ.z,z:aK.x * aJ.y - aK.y * aJ.x}
    }
    ...
    function u(aK, aJ) {
        return{x:aK.x - aJ.x,y:aK.y - aJ.y}
    }

    function b(aK, aJ) {
        return{x:aK.x - aJ.x,y:aK.y - aJ.y,z:aK.z - aJ.z}
    }
    ...
    function aq(aJ, aK) {
        return{x:aJ.x * aK,y:aJ.y * aK}
    }

    function ae(aJ, aK) {
        return{x:aJ.x * aK,y:aJ.y * aK,z:aJ.z * aK}
    }
    ...
    function J(aJ, aK) {
        return{x:aJ.e0 * aK.x + aJ.e1 * aK.y + aJ.e2 * aK.z + aJ.e3,y:aJ.e4 * aK.x + aJ.e5 * aK.y + aJ.e6 * aK.z + aJ.e7,z:aJ.e8 * aK.x + aJ.e9 * aK.y + aJ.e10 * aK.z + aJ.e11}
    }

    function Q(be, bd) {
        var bi = be.e0,bh = be.e1,bg = be.e2,bf = be.e3,bc = be.e4,bb = be.e5;
        var ba = be.e6,aY = be.e7,aW = be.e8,aV = be.e9,aS = be.e10,aQ = be.e11;
        var aU = bd.e0,aT = bd.e1,aR = bd.e2,aP = bd.e3,aO = bd.e4,aN = bd.e5;
        var aM = bd.e6,aL = bd.e7,aK = bd.e8,aJ = bd.e9,aZ = bd.e10,aX = bd.e11;
    ...
    function O(aN) {
        var aL = aN.e0,aK = aN.e1,aJ = aN.e2,aS = aN.e4,aR = aN.e5;
        var aP = aN.e6,aO = aN.e8,aM = aN.e9,aQ = aN.e10;
    ...
    function e(aK, aJ) {
        return{x:(aK.x + aJ.x) * 0.5,y:(aK.y + aJ.y) * 0.5,z:(aK.z + aJ.z) * 0.5}
    }
    ...
    function ad(aM, aL, aJ) {
        var aK = 1 - aJ;
        return{x:aK * aM.x + aJ * aL.x,y:aK * aM.y + aJ * aL.y,z:aK * aM.z + aJ * aL.z}
    }
    ...
    B.prototype.linearSubdivide = function ak() {
        ...
        for (var a3 = 0; a3 < aO; ++a3) {
            ...
            var aN = [[a1,a0].sort(),[a0,aY].sort(),[aY,aX].sort(),[aX,a1].sort(),[a1,a0,aY,aX].sort(),];
    ...
    B.makeSphere = function F(aU, aK, aJ) {
        ...
        for (var aZ = 0,aN = aV; aZ < aJ; ++aZ,aN += aV) {
            ...
            for (var aY = 0; aY < aK; ++aY) {
                var aL = a1 * aY;
                aM.push({x:aU * aS * Math.sin(aL),y:aU * aT,z:aU * aS * Math.cos(aL)})
            }
        }
    ...
    aC.prototype.projectPointToCanvas = function m(aL) {
        ...
        var aJ = aL.x * aK;
        var aM = aL.y * aK;
        return{x:(aJ + 1) * 300 + 100,y:(-aM + 1) * 300}
    };
    ...
    aC.prototype.registerMouseListener = function at(aK) {
        ...
        var aJ = aN.length == 0;
        aN.push(aK);
        var aO = {first_event:true,is_clicking:false,last_x:0,last_y:0,};
        if (!aJ) {
            return
        }
        var aM = this.canvas_;
        ...
        function aL(aQ) {
            if (typeof aQ.offsetX == "number") {
                return{x:aQ.offsetX,y:aQ.offsetY}
            }
            var aR = {x:0,y:0};
            var aP = aQ.target;
            ...
            return{x:aQ.layerX - aR.x,y:aQ.layerY - aR.y}
        }
        ...
        aM.addEventListener("mousemove", function(aT) {
            ...
            var aS = {is_clicking:aO.is_clicking,canvas_x:aO.last_x,canvas_y:aO.last_y,delta_x:aV,delta_y:aU,shift:aT.shiftKey,ctrl:aT.ctrlKey};
    ...
    aC.prototype.autoCamera = function D(aM, aL, aK, aQ, aP, aO, aU) {
        var aS = this.camera;
        var aR = this;
        var aJ = {rotate_x:aQ,rotate_y:aP,rotate_z:aO,x:aM,y:aL,z:aK};
    ...
    aC.prototype.draw = function aj(a4) {
        ...
        for (var bh = 0; bh < aJ; ++bh) {
            ...
            for (var bg = 0,aT = aX.numQuads(); bg < aT; ++bg) {
                ...
                bk.normal1 = a8;
                bk.normal2 = a7;
                var aL = {qf:bk,rgba:aM.fill_rgba || aN,texture:aM.texture,intensity:a9};
                aP.push(aL)
            }
        }
        aP.sort(ah);
    ...
    return{RGBA:aB,TextureInfo:l,Transform:az,Ticker:W,World:aC,Shape:B,Math:{crossProduct:ax,dotProduct2d:aE,dotProduct3d:ao,subPoints2d:u,subPoints3d:b,addPoints2d:a,addPoints3d:aD,mulPoint2d:aq,mulPoint3d:ae,vecMag2d:al,vecMag3d:X,unitVector2d:am,unitVector3d:Z,linearInterpolate:V},}
})();
window.addEventListener("load", function() {
    var c = document.getElementById("canvas");
    var g = new Soft3d.World(c);
    for (var f = 0; f < 10; ++f) {
        for (var e = 0; e < 10; ++e) {
            for (var d = 0; d < 10; ++d) {
                if (f == 0 || e == 0 || d == 0 || f == 9 || e == 9 || d == 9) {
                    var b = Soft3d.Shape.makeCube(0.5);
                    b.setRGBA(f / 10, e / 10, d / 10, 1);
                    b.transform.translate(f - 5, e - 5, d - 5);
                    g.addShape(b)
                }
            }
        }
    }
    var h = new Soft3d.World.DrawOptions();
    h.whiteout_rgba = new Soft3d.RGBA(0, 0, 0, 1);
    h.global_alpha = 0.3;
    function a() {
        g.draw(h)
    }

    g.setFocalLength(2.5);
    g.autoCamera(0, 0, -30, 0.4, -1.06, 0, a);
    cur_white = false;
    document.addEventListener("keydown", function(i) {
        ...
        if (cur_white) {
            ...
            h.whiteout_rgba = new Soft3d.RGBA(1, 1, 1, 1)
        }
        cur_white = !cur_white;
        a()
    }, false);
